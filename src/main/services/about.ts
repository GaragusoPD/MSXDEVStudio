 ...
 * MSXStudio's licence asks for exactly that. A test asserts the notice is
 ...
 * CC BY-SA 4.0 and asks for attribution, and the rest are the tools MSXStudio
...
export function aboutDetail(): string {
  return [
    ...
    'Do not sell MSXStudio itself, and credit the author in what you make.',
    '',
